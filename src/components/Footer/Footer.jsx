           ...
           {/* logo & CopyRight */}
            <div className='flex-1 basis-[300px]'>
                ...
                <p className='text-zinc-600 mt-6 max-w-[350px]'>
                    Bred for a high content of beneficial substances. Out products are all fresh and healthy.
                </p>
            ...
            <div className='flex-1'>
                ...
                <div className='flex bg-white p-1 rounded-lg mt-6'>
                    <input type="email" name='email' is='email' autoComplete='off' placeholder='Email Address' className='h-[5vh] pl-4 flex-1 focus:outline-none' />
