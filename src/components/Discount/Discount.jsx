    ...
    <section className='bg-zinc-100 bg-right bg-contain bg-no-repeat' style={{backgroundImage: `url(${FreshFruits})` }}>
        <div className='md:bg-transparent bg-zinc-100 flex md:flex-row flex-col max-w-[1400px] mx-auto px-10 py-10'>
            ...
            <div className='max-w-[700px]'>
                <h3 className='md:text-7xl text-4xl stext-zinc-800 font-bold mt-2'>First Order Discount!</h3>
                <p className='text-zinc-600 my-6 '>Enjoy an exclusive first order discount on our grocery website shop fresh essentails and save big on your first purchase. Fast delivery and wuality guaranted</p>
