...
const Process = () => {
    ...
    const renderSteps = steps.map(item=>{
        ...
        <div className={`flex-1 basis-[300px] ${item.id % 2 === 0 ? 'md:-mt-100' : ''}`}>
            <span className='flex w-18 h-18 mx-auto text-8xl bg-zinc-800  outline-[3px] outline-offset-7 outline-zinc-800 outline-dashed justify-center items-center rounded-full text-white'>{item.number}</span>
